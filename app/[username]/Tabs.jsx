...
export default function Tabs({ tabs, set, scroll = false, classes }) {
  ...
  return (
    <div className={`relative  dark:bg-black  pt-1.5 w-full px-4 border-b`}>
      <div
        ...
        className={`flex  overflow-x-scroll justify-between  gap-8  sm:gap-12`}
      >
        {tabs.map((tab, idx) => {
          return (
            <button
              ...
              className={`pt-1 pb-3   whitespace-nowrap text-[14px]  xs:text-[16px] w-fit ${
                activeTabIndex === idx
